...
empleadospage.myClass = BA.getDeviceClass ("b4a.example.empleadospage");
proyectospage.myClass = BA.getDeviceClass ("b4a.example.proyectospage");
...
proyecto.myClass = BA.getDeviceClass ("b4a.example.proyecto");
proyectos.myClass = BA.getDeviceClass ("b4a.example.proyectos");
